...
/**
 * Portado do Matriz (raiz), mesma lógica de cookie assinado por HMAC. O nome do
 * cookie é DELIBERADAMENTE diferente do de lá ("admin_session"): em produção os dois
 * sistemas respondem no mesmo domínio (movaci.com.br/matriz e /matriz2), então um
 * cookie com o mesmo nome e `path: "/"` nos dois coincidiria no navegador, cada
 * login sobrescrevendo o cookie do outro sistema.
 */
